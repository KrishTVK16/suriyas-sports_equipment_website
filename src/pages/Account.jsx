  ...
  return (
    <div className="min-h-screen bg-mountain-gray py-8 sm:py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="font-nunito font-extrabold text-4xl sm:text-5xl text-forest-green mb-6 sm:mb-8 text-center sm:text-left">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-1 space-y-6 order-1 lg:order-2">
              ...
              {user.role === 'admin' && (
                <div className="bg-sunset-orange text-white glossy-card p-4 sm:p-6">
