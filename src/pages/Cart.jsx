    ...
    return (
      <div className="min-h-screen bg-mountain-gray py-12 flex items-center justify-center px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h1 className="font-nunito font-extrabold text-4xl sm:text-5xl text-forest-green mb-6">
  ...
  return (
    <div className="min-h-screen bg-mountain-gray py-8 sm:py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="font-nunito font-extrabold text-4xl sm:text-5xl text-forest-green mb-8 sm:mb-12 text-center sm:text-left">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-4 order-2 lg:order-1">
            {cart.map((item) => (
              <motion.div
                ...
                className="bg-white glossy-card p-4 sm:p-6 flex flex-col sm:flex-row gap-4 sm:gap-6"
              >
                <img
                  src={item.image}
                  alt={item.name}
          ...
          <div className="lg:col-span-1 order-1 lg:order-2">
            <div className="bg-white glossy-card p-4 sm:p-6 sticky top-24">
