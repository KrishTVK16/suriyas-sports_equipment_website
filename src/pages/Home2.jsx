        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32">
          ...
          >
            <motion.h1
              ...
              className="font-nunito font-extrabold text-5xl sm:text-6xl md:text-7xl lg:text-8xl mb-6 sm:mb-8"
            >
              ELEVATE YOUR
              <br />
          ...
          >
            {[
              ...
              >
                ...
                <h3 className="font-nunito font-extrabold text-xl text-forest-green mb-2">
                  {feature.title}
                </h3>
                <p className="font-lato text-earth-brown">{feature.desc}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
